...
## I needed to create a solution to automatically detect unusual or high-risk transactions and Create the Alert. Visualize clearly for business users, and reduce manual review time while improving fraud spotting accuracy. Improve product with Product team.

## a. Requirement Gathering & Problem Definition:
